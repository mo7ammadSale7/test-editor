...
SECRET_KEY = '8q#&qu)-h_6uqd^(o9d_sy(-*=3z4&oqwqd&qephqfaz*6l88a'
...
CKEDITOR_5_CONFIGS = {
    ...
    'extends': {
        'toolbar': [
            'undo', 'redo', '|',
            'bold', 'blockQuote', 'italic', 'underline', 'strikethrough', '|',
            ...
            'indent', 'outdent', '|',
            'link', 'ckFinder', 'imageInsert', 'imageUpload', 'insertTable', 'mediaEmbed'
        ],
        'image': {
